...
<form action="${student.id==null ?'save':'update'}" method="POST">
        ...
        <input type="hidden" id="id" name="id" value="${student.laptop.lid}"><br><br>
        
        <label for="lname">Laptop name:</label><br>
        <input type="text" id="lname" name="lname" value="${student.laptop.lname}"><br><br>
